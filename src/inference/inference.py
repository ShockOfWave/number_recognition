    ...
    Methods:
        __init__: Initializes the inference class.
            Args:
                ...
                img_size (tuple): Size of the image (imgH, imgW). Default is (128, 128).
                beam_width (int): Width of the beam search decoder. Default is 10.
                device (torch.device): Device for inference. If None, it is automatically selected.
